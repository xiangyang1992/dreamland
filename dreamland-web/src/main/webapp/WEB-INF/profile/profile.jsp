...
<div style="margin-left: 100px;margin-top: 80px;" class="main-content">
    <div style="width: 300px;height: 600px;background-color:#D1D1D1 ;float: left">
        ...
        <div class="personal-image" style="width: 300px;height: 240px;">
                ...
                <a title="修改头像" class="avatar"><img id="img-change"  src="${user.imgUrl}" onclick="selectImg();" width="100" height="100" style="border-radius:50%;margin-top: 60px;margin-left: 90px;cursor: pointer;" data-drop-placeholder="修改头像"></a>
...
<script type="text/javascript" src="${ctx}/js/profile/profile.js?V=<%=UUID.randomUUID()%>"></script>
</html>