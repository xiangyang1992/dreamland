            ...
            <div id="content_col" class="content-main">
                    ...
                    <div class="content-text">
                        ...
                        <div class="author clearfix">
                            ...
                            <c:if test="${cont.uId == user.id}">
                                <%--<div class="update-dream" style="position: relative">
                                    <a class="update-dream" style="float: right" href="${ctx}/writedream?cid=${cont.id}"><span style="color: #9370db;font-size: 14px">编辑</span> </a>
                                </div>--%>
                            </c:if>
                        </div>
            ...
            <div class="foot" style="position: absolute;left: 0px;float: left;margin-top: 60px;">
                ...
                <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
                    <div class="foot-copyrights" style="margin-left: 200px">
                        ...
                        <p style="margin-top: 8px">&copy;www.dreamland.wang 博客境网版权所有</p>
                    </div>
                </div>
            </div>
            <!--col-md-9结束 -->
...
<script type="text/javascript" src="${ctx}/js/index.js?ver=<%=UUID.randomUUID()%>">
